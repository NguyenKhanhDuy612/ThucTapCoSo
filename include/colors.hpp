...
enum moreColor
{
	C_LIME = COLOR(210, 245, 60), //Chanh xanh
	C_GREEN = COLOR(60, 180, 75), //xanh la
	C_YELLOW = COLOR(255, 225, 25), //vang
	C_OLIVE = COLOR(128, 128, 0), //vang Olive
	C_BLUE = COLOR(0, 130, 200), //xanh bien
	C_ORANGE = COLOR(245, 130, 48), // cam
	C_PURPLE = COLOR(145, 30, 180), //tim
	C_CYAN = COLOR(70, 240, 240), //lam
	C_MAGENTA = COLOR(240, 50, 230), //do tuoi
	C_RED = COLOR(230, 25, 75), //do
	C_PINK = COLOR(250, 190, 190), //hong
	C_TEAL = COLOR(0, 128, 128), //do do
	C_LAVENDER = COLOR(230, 190, 255), //do dep
	C_BROWN = COLOR(170, 110, 40), // nau		
